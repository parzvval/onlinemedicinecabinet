...
$stmt = "SELECT * FROM usertable WHERE name = '".$_SESSION['username']."'";
...
<!-- BEGIN: Content-->
  <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">Connection</h3>
            </div>
            <div class="content-body">
                ...
                <section id="dom">
                  ...
                  <form method="POST" action="savecompl.php">
                    <textarea name="compl" class="form-control" cols="25" rows="3" required><?=$value['complaints']?></textarea>
                    <hr>
