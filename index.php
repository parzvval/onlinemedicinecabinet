...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img style="margin: auto;" src="onlinedoc.jpg" class="d-block img-fluid">
    ...
    <div class="carousel-item">
      <img src="loginadvice.png" class="d-block img-fluid">
         <div class="carousel-caption">
            <h5>Sign in or register by clicking on the button in the upright angle of the page, if you want to receive full medical consulting</h5>
        </div>
    </div>
    <div class="carousel-item">
  ...
  <section id="doctors">
       <center>
         <div class="doctorslist">Information about doctor</div>
            <h2><?php 
